...
@section('content')
<div id="edit" class="w-1/2 mx-auto ax-w-xs p-6 bg-blue-100 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-2" style="margin-top: 120px">
    <form action="{{ route('updateUserPenyedia', ['id' => Auth::user()->id]) }}" method="POST" >
