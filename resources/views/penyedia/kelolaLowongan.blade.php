...
@section('content')
    ...
    <div class="flex justify-end items-start mb-4 me-3" style="margin-top: 100px">
        <a href="{{ url('/penyedia/create') }}"
        ...
        <div id="main" class="flex flex-col md:flex-row w-full justify-center">
            ...
            <div>
                <div class="mx-4 space-y-6 mb-3">
                    @php
                        $lowonganAktif = $daftarPekerjaan2->filter(function ($pekerjaan) {
            ...
            @if($daftarPekerjaan->isEmpty())
                <div
                    class="flex flex-col items-center ms-4 ax-w-xs p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-auto">
                    <p class="text-center w-1/2"><em>Belum ada pekerjaan yang tersedia. Klik tombol "Tambah Lowongan" untuk membuatnya.</em></p>
                ...
                <div id="daftar" class=" w-1/3 flex flex-col" style="overflow-y:auto; max-height:430px; min-height: 300px; ">
                    @foreach ($daftarPekerjaan as $pekerjaan2)
                        <div class="max-w-xs p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-2">
                            ...
                            <a href="{{ route('kelolaLowongan', ['id' => $pekerjaan2->id]) }}"
            ...
            {{-- Detail Pekerjaan --}}
            @if ($pekerjaan)
                <div class="w-1/2 mx-2  pekerjaan-detail" style="overflow-y: auto;max-height: 500px;min-height: 300px; ">
                    {{-- Bagian Atas --}}
                    <div
                        ...
                        <div>
                            <div>
                                <div class="flex justify-center ">
                                    <a href="{{ url("/penyedia/$pekerjaan->id/edit") }}"
                                    ...
                                    <form method="POST" action="{{ url("/penyedia/$pekerjaan->id") }}"
            ...
            @else
                <div
                    class="mx-4 max-w-full p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 h-auto">
