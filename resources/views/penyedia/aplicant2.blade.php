...
@section('content')
            ...
            <div>
                <div class="mx-4 space-y-6 mb-3">
                    <div
                        ...
                        <dt class="text-center mb-1 text-gray-500 md:text-md dark:text-gray-400">Total Pelamar</dt>
                                        ...
                                        <div class="flex  gap-6 ">
                                            ...
                                            <div>
                                                <a href="{{ asset('storage/' . $applicant->resume_file) }}"
                                                    class="text-center bg-blue-100 rounded-lg p-2 text-md no-underline text-gray-500 font-semibold hover:bg-blue-200">
                                                    Lihat CV
                                                </a>
                                            </div>
                                        </div>
    ...
    <script>
        ...
        // untuk menampilkan terima/tolak
        ...
        // untuk memeriksa apakah sudah buat aksi atau belum
