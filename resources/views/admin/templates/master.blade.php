...
<body >
    <nav class="bg-blue-700 border-gray-200 dark:bg-gray-900 fixed top-0 w-full">
        <div class="flex justify-between items-center mx-auto max-w-screen-xl p-4">
            ...
            <div class="hidden md:flex flex space-x-8">
                <div class="relative">
                    <div class="flex gap-2 items-center">
                        ...
                        <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar" 
                                ...
                                <a href="{{ route('admin.index') }}" class="text-white no-underline hove:underline">Beranda</a>
                                <!-- Ikon Dropdown -->
                    ...
                    <div id="dropdownNavbar" class="z-10 hidden absolute mt-2 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="text-sm text-gray-700 dark:text-gray-400">
                            <li>
                                <a href="#kelola" class="block p-2 no-underline hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Kelola Sistem</a>
                            </li>
                            <li>
                                <a href="#analisis" class="block p-2 no-underline hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Analisis Data</a>
                            </li>
                        </ul>
                    </div>
                </div>
                <a href="{{route('admin-kelolaPengguna')}}" class="text-lg text-white font-medium no-underline hover:underline">
                    Kelola Pengguna
                </a>
                <a href="{{route('admin-kelolaLowongan')}}" class="text-lg text-white font-medium no-underline hover:underline">
                    Kelola Lowongan
                </a>
                <a href="{{route('admin-kelolaPelamar')}}" class="text-lg text-white font-medium no-underline hover:underline">
                    Kelola Pelamar
                </a>
            </div>
        ...
        <div id="mobile-menu" class="md:hidden flex flex-col items-start space-y-4 hidden bg-blue-700 text-white p-4">
            <a href="{{ route('admin.index') }}" class="no-underline text-lg text-white font-medium hover:underline">Beranda</a>
            <a href="{{route('admin-kelolaPengguna')}}" class="no-underline text-lg text-white font-medium hover:underline">Kelola Pengguna</a>
            <a href="{{route('admin-kelolaLowongan')}}" class="no-underline text-lg text-white font-medium hover:underline">Kelola Lowongan</a>
            <a href="{{route('admin-kelolaPelamar')}}" class="no-underline text-lg text-white font-medium hover:underline">Kelola Pelamar</a>
    ...
    <footer class="bg-blue-700 fixed w-full bottom-0 left-0 shadow dark:bg-gray-900 mt-4" >    
        <span class="p-3 block text-sm text-white sm:text-center dark:text-white">© 2024 JobScout™. All Rights Reserved.</span>     
    </footer>
